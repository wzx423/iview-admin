                        ...
                        <div id="preview" class="upload_preview">
                            <div class="preview-list" v-for="(item,index) in previewList" :key="index">
                                ...
                                <div class="preview-list-cover">
                                    <Icon type="md-close" @click="handleRemove(index)" size="20" style="position: absolute;top: 0; right: 0;cursor: pointer;color: #777;"/>
                                </div>
                            </div>
                            <div class="upload_choose">
                                ...
                                <input ref="upload" @change="chooseFile" type="file" name="" id="fileImage"  multiple accept="image/gif,image/jpeg,image/jpg,image/png" style="display: none;">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button @click="closeUpload" type="button" class="btn btn-text btn-large">{{cancelText}}</button>
                        <button id="fileSubmit" @click="submitFile" type="button" class="btn btn-primary btn-large upload_submit_btn">{{okText}}</button>
                    </div>
                </div>
            </div>
        </div>
